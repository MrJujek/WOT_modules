export function drawWN8Chart(wn8_x, data_y, chart_name) {
    ...
    const great = (ctx, value) => ((ctx.p0.parsed.y >= 2500) && (ctx.p1.parsed.y >= 2500)) ? value :
        undefined;
    const good = (ctx, value) => ((ctx.p0.parsed.y >= 1600) && (ctx.p1.parsed.y >= 1600)) ? value :
        undefined;
    const average = (ctx, value) => ((ctx.p0.parsed.y >= 1000) && (ctx.p1.parsed.y >= 1000)) ? value :
        undefined;
    const below_average = (ctx, value) => ((ctx.p0.parsed.y >= 500) && (ctx.p1.parsed.y >= 500)) ? value :
        undefined;
